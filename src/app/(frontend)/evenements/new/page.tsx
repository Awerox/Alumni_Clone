// src/app/(frontend)/evenements/new/page.tsx
import React from 'react'
import Link from 'next/link'
import { getAuthUser } from '@/lib/auth'
import NewEventFormClient from './NewEventFormClient'
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 font-sans">
        <div className="text-center p-8 bg-white border border-gray-200 rounded-3xl shadow-sm max-w-sm">
          ...
          <p className="text-xs text-gray-400 mt-1 mb-4">Connectez-vous pour créer un événement.</p>
          <Link href="/login?redirect=/evenements/new"
