      ...
      <section className="bg-white border-b border-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 space-y-6">
            ...
            <Link href="/about" className="inline-block bg-enc text-white px-8 py-3 rounded-xl font-bold text-xs uppercase tracking-wider hover:bg-opacity-90 transition-all shadow-sm">
              En savoir plus
            </Link>
          </div>
          <HeroSlider />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-2/5 flex flex-col items-center text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col gap-3 w-full max-w-xs font-black uppercase text-[10px] tracking-widest">
                <Link href="/jobs" className="w-full text-center py-3 bg-[#4c0519] hover:bg-[#3b0413] text-white rounded-xl shadow-xs transition-colors">Toutes les offres d'emploi</Link>
                <Link href="/jobs/new" className="w-full text-center py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl shadow-xs transition-colors flex items-center justify-center gap-1">
                ...
                return (
                  <div key={offre.id} className="bg-white border border-gray-200 rounded-2xl p-5 shadow-2xs hover:shadow-xs hover:border-gray-300 transition-all flex flex-col justify-between relative group">
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-100 flex justify-between items-center text-[9px] font-black uppercase tracking-widest">
                      ...
                      <Link href={`/jobs/${offre.id}`} className="text-emerald-500 hover:text-emerald-600 font-black flex items-center gap-0.5">Voir la fiche ➔</Link>
                    </div>
                  </div>
                )
              }) : (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-4 mb-12">
            ...
            <h2 className="text-xl font-black text-gray-800 whitespace-nowrap uppercase tracking-widest">Ils transmettent leur <span className="text-enc">expérience</span></h2>
            <div className="h-[1px] bg-enc flex-grow opacity-20"></div>
          </div>
